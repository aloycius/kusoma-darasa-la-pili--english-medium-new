...
**Kusoma** — Kitabu hiki ni cha somo la Kusoma kwa wanafunzi wa Darasa la Pili katika shule za English Medium, kikiwa kimeandaliwa Tanzania na Taasisi ya Elimu Tanzania kwa lugha ya Kiswahili. Kinalenga kuwajengea watoto wa kiwango cha elimu ya msingi cha awali stadi za kusikiliza, kuzungumza, kutambua herufi mwambatano, kusoma kwa ufasaha na kuelewa picha, hadithi, habari na mazungumzo. Maudhui yake yanasisitiza maadili na maisha ya kila siku kama usafi, nidhamu, usalama barabarani, utunzaji wa mazingira, ushirikiano na kuheshimu haki za watoto, kwa mtindo wa ujifunzaji shirikishi wenye maswali, mazoezi, nyimbo na shughuli za vitendo.
...
```
KUSOMA-DARASA-LA-PILI--ENGLISH-MEDIUM-NEW----HR/
├── adt/                              # THE WEB APP
...
├── KUSOMA-DARASA-LA-PILI--ENGLISH-MEDIUM-NEW----HR.db                    # SQLite database (pipeline state)
├── KUSOMA-DARASA-LA-PILI--ENGLISH-MEDIUM-NEW----HR.pdf                   # Original source PDF
...
{
  "pg001_gp001_tx001": "",
  "pg001_im001": "Cheti cha uthibati cha serikali ya Tanzania kwa kitabu cha Kusoma cha Darasa la Pili. Kimeandikwa jina la wizara, tarehe, na sahihi ya Kamishna wa Elimu."
}
```
...
| Original PDF | `KUSOMA-DARASA-LA-PILI--ENGLISH-MEDIUM-NEW----HR.pdf` |
| Pipeline database | `KUSOMA-DARASA-LA-PILI--ENGLISH-MEDIUM-NEW----HR.db` (SQLite) |
